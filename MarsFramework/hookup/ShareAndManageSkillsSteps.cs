...
{
    [Binding]
    public class ShareAndManageSkillsSteps:Base
    {
        ...
        {
            Assert.IsTrue(manageListingsinstance.searchskill("Oriya to English Translation"));
        }
        ...
        {
            Assert.IsFalse(manageListingsinstance.searchskill("Oriya to English Translation"));
        }
