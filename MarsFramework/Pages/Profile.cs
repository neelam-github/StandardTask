...
namespace MarsFramework
{
    internal class Profile
    {
        ...
        internal void EditProfile()
        {
         ...
         internal void Hover()
        {
            IWebElement element = Base.driver.FindElement(By.XPath("/html/body/div[1]/div/div[1]/div[2]/div/span"));
            Actions action = new Actions(Base.driver);
            action.MoveToElement(element).Build().Perform();
        }
        internal void ChangePwd()
        {
            String name = Base.driver.FindElement(By.XPath("/html/body/div[1]/div/div[1]/div[2]/div/span")).Text;
            if(name.Equals("Hi Neelam"))
            {
                IWebElement Pwd = Base.driver.FindElement(By.XPath("/ html / body / div[1] / div / div[1] / div[2] / div / span / div / a[2]"));
                Pwd.Click();
                //XPath for Current password
                IWebElement Current_Pwd = Base.driver.FindElement(By.XPath("/html/body/div[4]/div/div[2]/form/div[1]/input"));
                Current_Pwd.SendKeys("Hello@123");
                //XPath for New password
                IWebElement New_Pwd = Base.driver.FindElement(By.XPath("/html/body/div[4]/div/div[2]/form/div[2]/input"));
                New_Pwd.SendKeys("Hello@12345");

                //XPath for Confirm password
                IWebElement Confirm_Pwd = Base.driver.FindElement(By.XPath("/html/body/div[4]/div/div[2]/form/div[3]/input"));
                Confirm_Pwd.SendKeys("Hello@12345");

                //XPath for save button
                IWebElement Button = Base.driver.FindElement(By.XPath("/html/body/div[4]/div/div[2]/form/div[4]/button"));
                Button.Click();
